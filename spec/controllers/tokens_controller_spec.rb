  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved token as @token" do
        ...
        post :create, {:token => { "token" => "invalid value" }}, valid_session
        assigns(:token).should be_a_new(Token)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested token" do
        ...
        Token.any_instance.should_receive(:update).with({ "token" => "MyString" })
        put :update, {:id => token.to_param, :token => { "token" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the token as @token" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Token.any_instance.stub(:save).and_return(false)
        put :update, {:id => token.to_param, :token => { "token" => "invalid value" }}, valid_session
        assigns(:token).should eq(token)
      end
